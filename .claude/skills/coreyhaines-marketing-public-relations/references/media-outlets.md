...
- **Product Hunt, BetaList, Indie Hackers** - these are directories, not press. Use the `coreyhaines-marketing-directory-submissions` skill.
...
Store your live, working version in `projects/coreyhaines-marketing-public-relations/media-list.md` (per [journalist-pitching.md](journalist-pitching.md)).
