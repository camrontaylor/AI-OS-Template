---
name: coreyhaines-marketing-public-relations
description: "Land earned media for software products - find journalists, pitch stories, newsjack live news cycles, build media lists and press kits, respond to HARO and Qwoted requests. Not for directory submissions (see coreyhaines-marketing-directory-submissions), product launches (see coreyhaines-marketing-launch), social engagement (see coreyhaines-marketing-social), or cold outreach (see coreyhaines-marketing-cold-email)."
when_to_use: 'Invoke when the request sounds like: ''get press'', ''pitch a journalist'', ''press release'', ''newsjacking'', ''HARO'', ''media list'''
metadata:
  version: 1.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-public-relations` | Past corrections and preferences for this skill |
...
**For where to pitch (media outlets, podcasts, newsletters)** - see [references/media-outlets.md](references/media-outlets.md). For startup/SaaS/AI directories, use the separate `coreyhaines-marketing-directory-submissions` skill - different intent, different list.
