---
name: coreyhaines-marketing-ab-testing
description: "Design and run A/B tests and build a systematic growth experimentation program - hypotheses, sample-size and significance math, primary and guardrail metrics, ICE-scored experiment backlog. Not for tracking setup (see coreyhaines-marketing-analytics) or page-level conversion optimization (see coreyhaines-marketing-cro)."
when_to_use: 'Invoke when the request sounds like: "A/B test", "split test", "statistical significance", "how long should I run this test", "experiment backlog", "which version is better"'
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-ab-testing` | Past corrections and preferences for this skill |
...
- **coreyhaines-marketing-cro**: For generating test ideas based on CRO principles
- **coreyhaines-marketing-analytics**: For setting up test measurement
- **coreyhaines-marketing-copywriting**: For creating variant copy
