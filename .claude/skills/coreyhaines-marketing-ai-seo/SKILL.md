---
name: coreyhaines-marketing-ai-seo
description: "Optimize content to get cited and surfaced by AI search and assistants (Google AI Overviews, ChatGPT, Perplexity, Claude, Gemini) - extractable content structure, llms.txt, Open Knowledge Format bundles, and citation-gap analysis vs competitors. Not for traditional technical and on-page SEO audits (see coreyhaines-marketing-seo-audit) or structured data implementation (see coreyhaines-marketing-schema)."
when_to_use: 'Invoke when the request sounds like: ''AI SEO'', ''AEO'', ''GEO'', ''optimize for ChatGPT'', ''AI citations'', ''llms.txt'''
metadata:
  version: 2.2.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-ai-seo` | Past corrections and preferences for this skill |
...
Content with proper schema shows 30-40% higher AI visibility on non-Google AI engines. **Google's note**: structured data is "not required for generative AI search" but is recommended for overall SEO strategy. For implementation, use the **coreyhaines-marketing-schema** skill.
...
- **coreyhaines-marketing-seo-audit**: For traditional technical and on-page SEO audits
- **coreyhaines-marketing-schema**: For implementing structured data that helps AI understand your content
- **coreyhaines-marketing-content-strategy**: For planning what content to create
- **coreyhaines-marketing-competitors**: For building comparison pages that get cited
- **coreyhaines-marketing-programmatic-seo**: For building SEO pages at scale
- **coreyhaines-marketing-copywriting**: For writing content that's both human-readable and AI-extractable
