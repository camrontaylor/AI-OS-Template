---
name: coreyhaines-marketing-prospecting
description: "Build and qualify prospect lists across B2B SaaS, general B2B, local small business, and early-adopter demand-signal discovery - turning an ICP into a scored, verified, ready-to-outreach lead sheet. Not for writing the outbound copy (see coreyhaines-marketing-cold-email) or deep research on specific accounts (see coreyhaines-marketing-competitor-profiling)."
when_to_use: 'Invoke when the request sounds like: "build a prospect list", "find leads", "target account list", "find my first customers", "find local businesses"'
metadata:
  version: 1.1.0
---
...
| File | Load level | Why |
|---|---|---|
| `brand_context/product-marketing.md` | targeted | Product, audience, and positioning detail shared across these skills |
...
| `context/learnings.md` | `## coreyhaines-marketing-prospecting` | Past corrections and preferences for this skill |
...
Pull from AI-OS brand context in `brand_context/` (`positioning.md`, `icp.md`) if available. Otherwise, gather:
...
For implementation, see the [tools registry](docs/connectors.md). Key prospecting tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **Apollo** | B2B / SaaS firmographic + contact discovery | - | [apollo.md](docs/connectors.md) |
| **Clay** | Multi-source enrichment + waterfall | ✓ | [clay.md](docs/connectors.md) |
| **Clearbit** | Email-to-company enrichment | - | [clearbit.md](docs/connectors.md) |
| **ZoomInfo** | Enterprise B2B contact + intent | ✓ | [zoominfo.md](docs/connectors.md) |
| **Hunter** | Email pattern + verification | - | [hunter.md](docs/connectors.md) |
| **Snov** | Email finder + verifier | - | [snov.md](docs/connectors.md) |
| **Truelist** | Email deliverability validation | - | [truelist.md](docs/connectors.md) |
| **Outreach** | Sales engagement (post-list) | ✓ | [outreach.md](docs/connectors.md) |
| **RB2B** | Visitor identification (warm intent) | - | [rb2b.md](docs/connectors.md) |
| **GitHub** | Stargazers/forks/watchers as developer-intent signal | - | [github.md](docs/connectors.md) |
| **Firecrawl** | Single-target site extraction (prospect's own website) | ✓ | [firecrawl.md](docs/connectors.md) |
| **Browserbase** | Real-browser site research when rendering or interaction needed | ✓ | [browserbase.md](docs/connectors.md) |

---

## Related Skills

- **coreyhaines-marketing-cold-email**: For writing outbound sequences against the qualified list (the natural next step after prospecting)
- **coreyhaines-marketing-customer-research**: For understanding why current customers buy - informs the ICP definition
- **coreyhaines-marketing-competitor-profiling**: For deeper research on individual accounts (different from list-building qualification)
- **coreyhaines-marketing-revops**: For lead routing, lifecycle, and CRM handoff after prospecting
- **coreyhaines-marketing-sales-enablement**: For battle cards and one-pagers used in the outreach
- **coreyhaines-marketing-directory-submissions**: For inbound discovery surfaces (the prospects might find you back)
- **coreyhaines-marketing-product-marketing**: For the ICP definition that anchors every prospecting engagement
