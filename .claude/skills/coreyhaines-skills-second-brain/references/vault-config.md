...
| Folder | Purpose | Modifiable by `coreyhaines-skills-second-brain`? |
|---|---|---|
...
| `Projects/` | Project-specific notes | ❌ off-limits - `coreyhaines-skills-pm` skill territory |
| `Daily/` | Daily notes | ❌ off-limits |
| `Templates/` | Note templates | ❌ off-limits |
| `Notes/` | Misc | ❌ off-limits |
| `Tasks.md` | Task list | ❌ off-limits |
| `Kanban.md` | Personal kanban | ❌ off-limits - `coreyhaines-skills-pm` skill territory |
