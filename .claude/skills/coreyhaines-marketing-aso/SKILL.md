---
name: coreyhaines-marketing-aso
description: "Audit and optimize App Store and Google Play listings from a live URL - fetches the listing, scores metadata, visuals, keywords, and ratings, then delivers a prioritized action plan and competitor comparison. Not for web page SEO (see coreyhaines-marketing-seo-audit)."
when_to_use: 'Invoke when the request sounds like: ''ASO audit'', ''app store optimization'', ''optimize my app listing'', ''app store ranking'', ''why aren''t people downloading my app'', ''compare my app to competitors'''
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-aso` | Past corrections and preferences for this skill |
...
- **coreyhaines-marketing-cro**: For optimizing the conversion of web-based landing pages that drive app installs
- **coreyhaines-marketing-ad-creative**: For creating App Store and Google Play ad creatives
- **coreyhaines-marketing-analytics**: For setting up install attribution and in-app event tracking
- **coreyhaines-marketing-customer-research**: For understanding user needs and language to inform listing copy
