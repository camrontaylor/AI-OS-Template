---
name: coreyhaines-marketing-churn-prevention
description: "Reduce SaaS churn with cancel flows, dynamic save offers, exit surveys, dunning and failed-payment recovery, and proactive retention across billing tools like Stripe, Chargebee, and Paddle. Not for post-cancel win-back email sequences (see coreyhaines-marketing-emails) or in-app upgrade paywalls (see coreyhaines-marketing-paywalls)."
when_to_use: 'Invoke when the request sounds like: ''churn'', ''cancel flow'', ''save offer'', ''dunning'', ''people keep canceling'', ''how do I keep users'''
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-churn-prevention` | Past corrections and preferences for this skill |
...
**How to run cancel flow experiments:** Use the **coreyhaines-marketing-ab-testing** skill to design statistically rigorous tests. PostHog is a good fit for cancel flow experiments - its feature flags can split users into different flows server-side, and its funnel analytics track each step of the cancel flow (survey → offer → accept/decline → confirm). See the [AI-OS connectors map](../../../docs/connectors.md) for connecting PostHog.
...
- **coreyhaines-marketing-emails**: For win-back email sequences after cancellation
- **coreyhaines-marketing-paywalls**: For in-app upgrade moments and trial expiration
- **coreyhaines-marketing-pricing**: For plan structure and annual discount strategy
- **coreyhaines-marketing-onboarding**: For activation to prevent early churn
- **coreyhaines-marketing-analytics**: For setting up churn signal events
- **coreyhaines-marketing-ab-testing**: For testing cancel flow variations with statistical rigor
