...
2. **Show a comparison** if you have one (see coreyhaines-marketing-competitors)
...
**For detailed win-back email sequences**: See the coreyhaines-marketing-emails skill.
