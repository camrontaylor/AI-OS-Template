...
- **Pricing tier > offer construction** - for self-serve SaaS, packaging and value metric do more work than guarantees and bonuses. Use the `coreyhaines-marketing-pricing` skill.
...
For SaaS, this skill is supplemental. Read [`coreyhaines-marketing-pricing`](../../coreyhaines-marketing-pricing/SKILL.md) first.
