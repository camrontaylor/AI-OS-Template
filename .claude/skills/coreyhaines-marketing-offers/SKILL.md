---
name: coreyhaines-marketing-offers
description: "Design or improve the thing you actually sell: value framing, bonus stacking, guarantees and risk reversal, scarcity and urgency, naming, and payment structure. Best for services, courses, coaching, info products, and high-ticket. Not for price tiers, freemium, or value metric (coreyhaines-marketing-pricing)."
when_to_use: 'Invoke when the request sounds like: ''design an offer'', ''grand slam offer'', ''value stack'', ''guarantee'', ''productize a service'', ''why isn''t my offer converting'''
metadata:
  version: 1.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-offers` | Past corrections and preferences for this skill |
...
- **coreyhaines-marketing-pricing** - for price levels, tier structure, value metric, packaging, freemium
- **coreyhaines-marketing-copywriting** - for the page that presents the offer
- **coreyhaines-marketing-cro** - for optimizing the conversion path the offer travels through
- **coreyhaines-marketing-launch** - for the moment you ship the offer
- **coreyhaines-marketing-paywalls** - for in-app upgrade-prompt versions of an offer
- **coreyhaines-marketing-sales-enablement** - for the deck and one-pager that carry the offer into a sales conversation
- **coreyhaines-marketing-emails** - for the email sequence that warms up the offer
- **coreyhaines-marketing-marketing-psychology** - for the cognitive biases that make offers land or bounce
