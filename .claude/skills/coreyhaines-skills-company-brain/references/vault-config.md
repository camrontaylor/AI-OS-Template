...
Company brain lives at `${COMPANY_BRAIN_VAULT:-projects/coreyhaines-skills-company-brain}/` inside the AI-OS repo by default. Set `COMPANY_BRAIN_VAULT` to point at an external Obsidian or Git-backed vault instead (needs your own vault).
...
# 5. Seed CLAUDE.md (copy from the AI-OS skill's schema starter as starting point)
cp <AI-OS>/.claude/skills/coreyhaines-skills-company-brain/references/schema.md CLAUDE.md
