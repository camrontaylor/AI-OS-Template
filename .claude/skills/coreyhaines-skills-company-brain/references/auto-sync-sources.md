...
- **Setup**: wire the webhook via `coreyhaines-skills-toolify fathom` when ready
...
- **Setup**: `coreyhaines-skills-toolify gong` + schedule daily sync via `coreyhaines-skills-loopify`
...
- **Setup**: `coreyhaines-skills-toolify <email-provider>` when the team is ready
...
- **Setup**: `coreyhaines-skills-toolify hubspot` + nightly sync via `coreyhaines-skills-loopify`
...
Wire via `coreyhaines-skills-loopify` with these defaults:
...
Each recipe pairs `coreyhaines-skills-toolify <source>` (initial wiring) + `coreyhaines-skills-loopify` (scheduled sync).
