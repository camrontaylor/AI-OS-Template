---
name: coreyhaines-marketing-ads
description: "Plan, optimize, and scale paid ad campaigns on Google, Meta, LinkedIn, and X - budgets, audience targeting, bidding, retargeting, ABM, and ROAS/CPA optimization, including when to kill an ad. Not for bulk ad copy generation (see coreyhaines-marketing-ad-creative) or landing page optimization (see coreyhaines-marketing-cro)."
when_to_use: 'Invoke when the request sounds like: ''PPC'', ''paid media'', ''should I run ads'', ''negative keywords'', ''Performance Max'', ''when should I kill an ad'''
metadata:
  version: 2.2.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-ads` | Past corrections and preferences for this skill |
...
For implementation, see the [AI-OS connectors map](../../../docs/connectors.md). Key advertising platforms:

| Platform | Best For | MCP | Guide |
|----------|----------|:---:|-------|
| **Google Ads** | Search intent, high-intent traffic | ✓ | [connectors map](../../../docs/connectors.md) |
| **Meta Ads** | Demand gen, visual products, B2C | - | [connectors map](../../../docs/connectors.md) |
| **LinkedIn Ads** | B2B, job title targeting | - | [connectors map](../../../docs/connectors.md) |
| **TikTok Ads** | Younger demographics, video | - | [connectors map](../../../docs/connectors.md) |

For tracking setup, see [references/conversion-tracking.md](references/conversion-tracking.md) and the [AI-OS connectors map](../../../docs/connectors.md)

---

## Related Skills

- **coreyhaines-marketing-ad-creative**: For generating and iterating ad headlines, descriptions, and creative at scale
- **coreyhaines-marketing-revops**: For the CRM side of ABM - lead scoring, routing, and the offline conversion loop
- **coreyhaines-marketing-customer-research**: For the voice-of-customer inputs that feed ad copy and creative angles
- **coreyhaines-marketing-copywriting**: For landing page copy that converts ad traffic
- **coreyhaines-marketing-analytics**: For proper conversion tracking setup
- **coreyhaines-marketing-ab-testing**: For landing page testing to improve ROAS
- **coreyhaines-marketing-cro**: For optimizing post-click conversion rates
