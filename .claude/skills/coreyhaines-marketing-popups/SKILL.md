---
name: coreyhaines-marketing-popups
description: "Build and optimize interrupt-style conversion elements - popups, modals, overlays, slide-ins, exit-intent, sticky bars, and announcement banners - that convert without annoying users. Not for non-popup forms or general page conversion optimization (see coreyhaines-marketing-cro)."
when_to_use: 'Invoke when the request sounds like: "exit intent popup", "email capture popup", "announcement banner", "sticky bar", "modal optimization", "scroll trigger"'
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-popups` | Past corrections and preferences for this skill |
...
- **coreyhaines-marketing-lead-magnets**: For planning lead magnets to promote via popups
- **coreyhaines-marketing-cro**: For optimizing the form inside the popup
- **coreyhaines-marketing-cro**: For the page context around popups
- **coreyhaines-marketing-emails**: For what happens after popup conversion
- **coreyhaines-marketing-ab-testing**: For testing popup variations
