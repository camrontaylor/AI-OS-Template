---
name: coreyhaines-marketing-influencer-marketing
description: "Run influencer, creator, and ambassador partnerships end to end: find and vet partners, structure and price deals, brief creators, keep disclosure FTC-compliant, and measure real ROI across B2C and B2B. Not for affiliate/referral payout mechanics (see coreyhaines-marketing-referrals), community-led advocacy (see coreyhaines-marketing-community-marketing), or turning creator content into paid ads (see coreyhaines-marketing-ad-creative)."
when_to_use: 'Invoke when the request sounds like: "influencer marketing", "creator partnerships", "brand ambassador", "podcast or YouTube sponsorships", "how much to pay an influencer", "product seeding", "FTC disclosure", "ambassador program"'
metadata:
  version: 1.0.0
---
...
| `brand_context/icp.md` | targeted | The audience a partner's followers must match |
| `brand_context/voice-profile.md` | targeted | Brand voice and brand-safety redlines |
| `brand_context/assets.md` | targeted | Logos, product, and briefing assets |
| `context/learnings.md` | `## coreyhaines-marketing-influencer-marketing` | Past corrections and preferences for this skill |

## Before Starting

**Check for product marketing context first.** Read the AI-OS brand context in `brand_context/` (`positioning.md`, `icp.md`, `voice-profile.md`) before asking questions - the ICP, positioning, and offer anchor every partner-fit decision. Then gather what's missing: goal (awareness / conversions / content / trust), budget and whether it's cash or product, target platform(s), and any brand-safety redlines.
...
For implementation, see the [AI-OS connectors map](../../../docs/connectors.md).

| Tool | Best for | Guide |
|------|----------|-------|
| **SparkToro** | Audience intelligence - where your ICP actually pays attention, and vetting a creator's real audience | [connectors map](../../../docs/connectors.md) |
...
- **coreyhaines-marketing-referrals** - affiliate/commission tracking and payout rails (the performance side of creator deals)
- **coreyhaines-marketing-community-marketing** - community-led advocacy and the unpaid advocate program
- **coreyhaines-marketing-ad-creative** - repurpose creator content into paid ads (whitelisting); creative review page for sign-off
- **coreyhaines-marketing-cold-email** - the creator outreach itself (personalization, deliverability, follow-up)
- **coreyhaines-marketing-customer-research** - find existing advocates and ground the talking points
- **coreyhaines-marketing-ai-seo** - the branded-search/direct attribution blind spot that hides influencer impact
- **coreyhaines-marketing-social** - organic content strategy the partnerships plug into
