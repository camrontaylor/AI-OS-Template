---
name: coreyhaines-marketing-image
description: "Create, generate, edit, and optimize marketing images: blog heroes, social graphics, product mockups, banners, profile covers, OG images, plus web optimization (WebP, compression). Routes across AI models (Flux, Midjourney, DALL-E, Ideogram, Nano Banana) and design tools. Not for paid ad creative (coreyhaines-marketing-ad-creative) or video (coreyhaines-marketing-video)."
when_to_use: 'Invoke when the request sounds like: ''generate an image'', ''create a graphic'', ''product mockup'', ''hero image'', ''OG image'', ''compress images'''
metadata:
  version: 2.0.1
---
...
| `context/learnings.md` | `## coreyhaines-marketing-image` | Past corrections and preferences for this skill |
...
| App Store screenshots | Varies by device | See coreyhaines-marketing-aso skill for full specs |
...
- **coreyhaines-marketing-ad-creative**: For paid ad image creative, platform-specific ad specs, and scaled ad production
- **coreyhaines-marketing-video**: For AI video production and programmatic video
- **coreyhaines-marketing-social**: For what to post and content strategy
- **coreyhaines-marketing-cro**: For image placement and conversion optimization on landing pages
- **coreyhaines-marketing-seo-audit**: For image SEO (alt text, file names, lazy loading)
- **coreyhaines-marketing-aso**: For app store screenshot specs and optimization
- **coreyhaines-marketing-directory-submissions**: For Product Hunt gallery images and directory listing visuals
