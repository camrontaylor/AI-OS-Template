...
description: >
  Turn websites into LLM-ready data with the Firecrawl API: scrape, crawl, map, search, extract, batch, and change tracking, with JavaScript rendering and anti-bot bypass. Needs FIRECRAWL_API_KEY. Use for scraping or crawling sites, web search plus scrape, or extracting brand/design systems. Not for general browsing or simple URL fetches that WebFetch handles.
user-invocable: true
---
