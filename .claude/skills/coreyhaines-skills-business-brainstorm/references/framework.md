...
Does this complement or cannibalize the user's existing properties?
...
Check AI-OS memory (`projects/` folders, `context/MEMORY.md`) - does this idea overlap with any in-flight projects? If yes, ask: should this be a feature of one of those?
...
- **3+ ❓ (unknowns)** → run `coreyhaines-skills-deep-research` first, then re-score
