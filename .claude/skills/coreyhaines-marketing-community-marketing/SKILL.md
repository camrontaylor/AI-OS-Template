---
name: coreyhaines-marketing-community-marketing
description: "Design, launch, and grow an online community for product growth and loyalty - platform strategy across Discord, Slack, Circle, Reddit, and forums, plus brand advocates, ambassador programs, and community-led growth loops. Not for customer referral programs (see coreyhaines-marketing-referrals)."
when_to_use: 'Invoke when the request sounds like: ''build a community'', ''community strategy'', ''Discord community'', ''community-led growth'', ''ambassador program'', ''brand advocates'''
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-community-marketing` | Past corrections and preferences for this skill |
...
- **coreyhaines-marketing-referrals**: For structured referral and ambassador incentive programs
- **coreyhaines-marketing-churn-prevention**: For retention strategies that complement community engagement
- **coreyhaines-marketing-social**: For content creation across social platforms
- **coreyhaines-marketing-customer-research**: For understanding your community members' needs and language
