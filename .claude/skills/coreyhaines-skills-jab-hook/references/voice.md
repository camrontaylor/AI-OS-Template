...
1. Create `projects/coreyhaines-skills-jab-hook/voice.local.md`
2. Put your additional voice rules / banned phrases / personal stylistic preferences in there
3. The `coreyhaines-skills-jab-hook` skill loads `voice.md` first (this file, generic), then `voice.local.md` (yours, additive) so your personal rules override or extend the defaults
