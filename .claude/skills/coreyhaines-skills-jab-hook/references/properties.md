...
**Personal property list lives at `projects/coreyhaines-skills-jab-hook/properties.yaml`** - not in this repo (gitignored, on disk only).
...
cp .claude/skills/coreyhaines-skills-jab-hook/references/properties.example.yaml \
   projects/coreyhaines-skills-jab-hook/properties.yaml

# Edit projects/coreyhaines-skills-jab-hook/properties.yaml - add your real properties
```
...
1. Reads `projects/coreyhaines-skills-jab-hook/properties.yaml`
...
Edit `projects/coreyhaines-skills-jab-hook/properties.yaml` and re-run `coreyhaines-skills-jab-hook` - no other change needed. The skill picks up the new config on every run.
