...
**Your extracted patterns live at `projects/coreyhaines-skills-jab-hook/patterns.local.md`** - not in this repo (gitignored, on disk only). The patterns you've mined from inspiration accounts are your taste - keep them private.
...
After running `coreyhaines-skills-jab-hook` with an inspiration scan, the extracted patterns are appended to `projects/coreyhaines-skills-jab-hook/patterns.local.md`. The skill numbers them sequentially.
