---
name: coreyhaines-marketing-seo-audit
description: "Audit and diagnose SEO problems - crawlability, indexation, Core Web Vitals, on-page tags, internal links, E-E-A-T, and hreflang/international - then return a prioritized fix list. Not for building pages at scale (see coreyhaines-marketing-programmatic-seo) or structured data (see coreyhaines-marketing-schema)."
when_to_use: 'Invoke when the request sounds like: "SEO audit", "technical SEO", "why am I not ranking", "traffic dropped", "core web vitals", "indexing issues"'
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-seo-audit` | Past corrections and preferences for this skill |
