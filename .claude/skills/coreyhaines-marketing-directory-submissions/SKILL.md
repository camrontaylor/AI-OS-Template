---
name: coreyhaines-marketing-directory-submissions
description: "Plan and run product directory submissions for backlinks, domain rating, and discovery - Product Hunt, BetaList, G2, Capterra, AI and MCP registries - with positioning variants and a submission tracker. Not for the broader launch moment (see coreyhaines-marketing-launch), programmatic SEO pages (see coreyhaines-marketing-programmatic-seo), or AI citation optimization (see coreyhaines-marketing-ai-seo)."
when_to_use: 'Invoke when the request sounds like: "submit to directories", "directory submissions", "dofollow backlinks", "list my product", "submit to Product Hunt", "directory tracker"'
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-directory-submissions` | Past corrections and preferences for this skill |
...
- **coreyhaines-marketing-launch** - broader launch moment, ORB framework, five-phase approach
- **coreyhaines-marketing-programmatic-seo** - destination pages (alternatives, integrations, templates) that backlinks should flow into
- **coreyhaines-marketing-competitors** - `/alternatives/[tool]` page pattern
- **coreyhaines-marketing-ai-seo** - GEO optimization for AI citation
- **coreyhaines-marketing-content-strategy** - editorial content that attracts "best of" listicle inclusions
- **coreyhaines-marketing-free-tools** - lead magnets for destination pages
- **coreyhaines-marketing-community-marketing** - Reddit, Indie Hackers, Slack community mechanics
- **coreyhaines-marketing-schema** - FAQ + Product + Organization JSON-LD for GEO
