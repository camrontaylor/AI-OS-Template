...
def _find_ytdlp() -> str:
    """Return yt-dlp binary path. Checks PATH first, then pip user-install locations."""
    ...
    raise SystemExit(
        "yt-dlp is not installed. Install with: pip3 install --user yt-dlp"
    )
