...
Copy this file to `projects/coreyhaines-marketing-social/listening-sources.md` and fill in the brackets. Claude reads it when running the [listening workflow](listening.md).
