---
name: coreyhaines-marketing-social
description: "Create, repurpose, schedule, and optimize social content across LinkedIn, X, Instagram, TikTok, and Facebook - content pillars, hooks, carousels, short-form video scripts, engagement, and social listening. Not for broader content strategy (see coreyhaines-marketing-content-strategy) or paid ad creative (see coreyhaines-marketing-ad-creative)."
when_to_use: 'Invoke when the request sounds like: "LinkedIn post", "Twitter thread", "content calendar", "repurpose this content", "what should I post", "social listening"'
metadata:
  version: 2.2.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-social` | Past corrections and preferences for this skill |
