---
name: coreyhaines-marketing-attribution
description: "Figure out which marketing actually drives conversions and revenue: choose and interpret attribution models (first/last-touch, multi-touch, MMM, incrementality), reconcile conflicting numbers across ad platforms, GA, and CRM, and instrument first-party attribution yourself. Not for event-tracking setup and UTMs (see coreyhaines-marketing-analytics), ad-platform pixels/CAPI (see coreyhaines-marketing-ads), or CRM pipeline reporting (see coreyhaines-marketing-revops)."
when_to_use: 'Invoke when the request sounds like: "which channel drives revenue", "my dashboards disagree", "Google says X but GA says Y", "what''s my real CAC", "first-touch vs last-touch", "MMM", "incrementality", "how did you hear about us", "close the identify gap"'
metadata:
  version: 1.1.0
---
...
Product context: read the AI-OS brand context in `brand_context/` (`positioning.md`, `icp.md`) if present - business type, sales cycle, and primary conversion drive almost every recommendation here.
...
| `brand_context/icp.md` | targeted | Who the buyer is |
| `brand_context/assets.md` | targeted | Connected analytics, ad, and CRM tools |
| `context/learnings.md` | `## coreyhaines-marketing-attribution` | Past corrections and preferences for this skill |
...
For implementation, see the [AI-OS connectors map](../../../docs/connectors.md). Key tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **PostHog** | First-party attribution, identify/merge, funnels | - | [connectors map](../../../docs/connectors.md) |
| **GA4** | Web analytics, model comparison, user-id stitching | ✓ | [connectors map](../../../docs/connectors.md) |
| **Dub** | Short-link + click attribution | ✓ | [connectors map](../../../docs/connectors.md) |
| **Segment** | CDP - route identify/track to every destination | - | [connectors map](../../../docs/connectors.md) |
| **HubSpot** | CRM lead-source + self-reported fields | ✓ | [connectors map](../../../docs/connectors.md) |
| **Salesforce** | CRM as revenue source of truth | - | [connectors map](../../../docs/connectors.md) |
| **Supermetrics** | Pull platform numbers into one place to reconcile | ✓ | [connectors map](../../../docs/connectors.md) |
| **RB2B** | De-anonymize B2B website visitors | - | [connectors map](../../../docs/connectors.md) |

---

## Related Skills

- **coreyhaines-marketing-analytics** - event tracking, tracking plans, UTMs, GA4/GTM setup. Do this *before* attribution.
- **coreyhaines-marketing-ads** - ad-platform pixels, CAPI, server-side conversion tracking.
- **coreyhaines-marketing-revops** - pipeline stages, lead lifecycle, CRM revenue reporting. Attribution feeds it.
- **coreyhaines-marketing-ai-seo** - the AI-search attribution blind spot in depth.
- **coreyhaines-marketing-ab-testing** - controlled experiments; the incrementality mindset applied to on-site changes.
