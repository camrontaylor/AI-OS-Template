...
This is the template. Your real board mappings live in `projects/coreyhaines-skills-pm/boards.md`, not in the skill folder. Copy the schema below and populate it there.
