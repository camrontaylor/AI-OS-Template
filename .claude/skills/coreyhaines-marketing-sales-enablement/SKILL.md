---
name: coreyhaines-marketing-sales-enablement
description: "Create sales collateral reps actually use - pitch decks, one-pagers, leave-behinds, objection-handling docs, demo scripts, talk tracks, playbooks, deal-specific ROI. Not for competitor comparison pages and battle cards (see coreyhaines-marketing-competitors), website copy (see coreyhaines-marketing-copywriting), or the offer itself (see coreyhaines-marketing-offers)."
when_to_use: 'Invoke when the request sounds like: ''sales deck'', ''one-pager'', ''objection handling'', ''demo script'', ''sales playbook'', ''help my sales team'''
metadata:
  version: 2.0.1
---
...
| `context/learnings.md` | `## coreyhaines-marketing-sales-enablement` | Past corrections and preferences for this skill |
...
For partner sales enablement, see the [tools registry](docs/connectors.md):

| Tool | What It Does | Guide |
|------|-------------|-------|
| **Introw** | Partner engagement tracking, deal registration, mutual action plans | [introw.md](docs/connectors.md) |
