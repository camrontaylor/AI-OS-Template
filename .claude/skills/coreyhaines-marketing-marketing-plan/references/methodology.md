...
```
projects/coreyhaines-marketing-marketing-plan/{client-slug}/
...
- **Cross-reference check** - every marketing-ideas number (e.g., "idea #17") matches the actual idea in `references/idea-cross-reference.md`. Every related-skill mention either exists in the AI-OS `.claude/skills/` catalog or is documented as an external dependency (see ops-stack-mapping note on optional tools).
...
> *"Marketing Plan v1 saved to `projects/coreyhaines-marketing-marketing-plan/{client-slug}/final_plan.md`. ~X,XXX words across 13 sections. Ready to paste into Notion or share with the team."*
