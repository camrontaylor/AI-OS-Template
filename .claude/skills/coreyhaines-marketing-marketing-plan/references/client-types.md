...
### Skills emphasis
- `coreyhaines-marketing-cold-email`, `coreyhaines-marketing-programmatic-seo`, `coreyhaines-marketing-competitors`, `coreyhaines-marketing-seo-audit`, `coreyhaines-marketing-ai-seo`
- `coreyhaines-marketing-ads` weighted toward LinkedIn + Google
- `coreyhaines-marketing-emails` for trial nurture + lifecycle
- `coreyhaines-marketing-pricing` for tier optimization
...
### Skills emphasis
- `coreyhaines-marketing-onboarding`, `coreyhaines-marketing-paywalls`, `coreyhaines-marketing-emails`
- `coreyhaines-marketing-ads`, `coreyhaines-marketing-ad-creative` (heavy creative iteration)
- `coreyhaines-marketing-referrals`
- `coreyhaines-marketing-pricing` for annual default + tier consolidation
...
### Skills emphasis
- `coreyhaines-marketing-seo-audit` for Shopify product pages
- `coreyhaines-marketing-emails` for both hardware post-purchase and software lifecycle
- `coreyhaines-marketing-referrals` with gifting layer
- `coreyhaines-marketing-pricing` for blended-bundle math
- `coreyhaines-marketing-ads` with creative-heavy Meta presence
...
### Skills emphasis
- `coreyhaines-marketing-programmatic-seo` for city pages, vertical pages
- `coreyhaines-marketing-cold-email` for supply-side recruitment
- `coreyhaines-marketing-referrals` for both sides
- `coreyhaines-marketing-pricing` for take-rate decisions
...
### Skills emphasis
- `coreyhaines-marketing-programmatic-seo` for docs
- Less emphasis on traditional `coreyhaines-marketing-ads`
- Heavy `coreyhaines-marketing-content-strategy` + technical content
- `coreyhaines-marketing-cold-email` to engineering leads at target companies
...
- Heavy `coreyhaines-marketing-product-marketing`, `coreyhaines-marketing-sales-enablement`, `coreyhaines-marketing-pricing`
- `coreyhaines-marketing-cold-email` to specific researchers / practitioners
...
### Skills emphasis
- `coreyhaines-marketing-ads` + `coreyhaines-marketing-ad-creative` (heavy weight)
- `coreyhaines-marketing-emails` for post-purchase + abandoned cart
- `coreyhaines-marketing-referrals` with gifting
- `coreyhaines-marketing-pricing` for bundles + subscription option
