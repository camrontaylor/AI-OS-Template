...
> **Note on scope.** Skills below live in the AI-OS `.claude/skills/` catalog. A few references point to optional tools or connectors that may not be installed (e.g., `agent-browser`, a diagram maker) - substitute equivalents if not available. When a plan references a skill or tool that isn't available, fall back to the underlying tactic and call it out in Section 13's open decisions.
...
|---|---|---|
| `coreyhaines-marketing-seo-audit` | Audit site for technical and on-page SEO | Quarterly site health checks |
| `coreyhaines-marketing-ai-seo` | Optimize content for AI search engines / LLM citation | Future-proof content strategy |
| `coreyhaines-marketing-programmatic-seo` | Build template-driven SEO pages at scale | Location, comparison, integration page systems |
| `coreyhaines-marketing-schema` | Add structured data markup | Rich snippets, eligibility for AI citation |
| `coreyhaines-marketing-content-strategy` | Plan content topics, pillars, cadence | Setting the editorial calendar |
| `coreyhaines-marketing-competitors` | Build vs-pages and alternative-to-pages | Capture high-intent SERPs against competitors |
| `coreyhaines-marketing-ads` | Plan and structure paid campaigns | Apple Search Ads, Meta, Google, LinkedIn |
| `coreyhaines-marketing-ad-creative` | Generate ad variations and creative | Iterate ad creative across platforms |
| `coreyhaines-marketing-social` | Plan and write social media content | LinkedIn, Twitter/X, Instagram, TikTok |
| `typefully` (needs your own Typefully account) | Schedule/post tweets, threads, LinkedIn content | Cadence operations for founder-led channels |
| `coreyhaines-marketing-cold-email` | Write B2B cold outreach + sequences | Outbound for B2B SaaS / hybrid businesses |
| `coreyhaines-marketing-analytics` | Set up tracking, GA4, conversion events | Funnel instrumentation |
| `coreyhaines-marketing-free-tools` | Plan engineering-as-marketing free tools | Build tools that generate links + leads |
| `marketing-website-design` | Design marketing sites with intention | Pillar/landing page design |
| `coreyhaines-marketing-launch` | Plan and execute launches (Product Hunt, GA, feature launches) | GTM moments - strategy + tactical execution |

### Activation skills

| Skill | What it does | Primary use in Activation |
|---|---|---|
| `coreyhaines-marketing-onboarding` | Optimize user onboarding flows | Onboarding rebuild, activation rate tests |
| `coreyhaines-marketing-signup` | Optimize signup/registration | Reduce friction at top of activation |
| `coreyhaines-marketing-cro` | Optimize any marketing page or form | Conversion testing across pages, forms, landing pages |
| `coreyhaines-marketing-paywalls` | Optimize paywalls and upgrade screens | Trial → paid conversion (also Revenue) |
| `coreyhaines-marketing-popups` | Optimize popups, modals, slide-ins | Lead capture + activation prompts |
| `coreyhaines-marketing-copywriting` | Write marketing copy | Onboarding screens, paywall copy, CTAs |
| `coreyhaines-marketing-copy-editing` | Edit and improve existing copy | Voice / clarity pass before ship |
...
| `coreyhaines-marketing-ab-testing` | Plan A/B tests | Structure for onboarding variant tests |
| `coreyhaines-marketing-marketing-psychology` | Apply behavioral science to copy and CRO | Persuasion principles in activation moments |

### Retention skills

| Skill | What it does | Primary use in Retention |
|---|---|---|
| `coreyhaines-marketing-emails` | Design email sequences | Customer.io / Mailchimp / Resend flow building |
| `coreyhaines-marketing-churn-prevention` | Build cancellation flows, save offers, win-back | Reduce churn, recover failed payments |
| `coreyhaines-marketing-copywriting` / `coreyhaines-marketing-copy-editing` | Email copy production | Lifecycle email content |
| `coreyhaines-marketing-paywalls` | (cross-cuts) - upgrade prompts in retention emails | Upsell within lifecycle |
| `coreyhaines-marketing-ab-testing` | Test email variants | Subject line, CTA, timing tests |

### Referral skills

| Skill | What it does | Primary use in Referral |
|---|---|---|
| `coreyhaines-marketing-referrals` | Plan and launch referral / affiliate / ambassador programs | Core skill for Section 7 |
| `coreyhaines-marketing-social` | Create ambassador-shareable content | Talking points, post templates |
| `coreyhaines-marketing-copywriting` | Ambassador / affiliate email copy | Recruitment, onboarding, communication |
| `marketing-website-design` | Per-ambassador landing pages | Attribution surface |
| `coreyhaines-marketing-emails` | Ambassador lifecycle emails | Onboarding, monthly digest, payout notifications |

### Revenue skills

| Skill | What it does | Primary use in Revenue |
|---|---|---|
| `coreyhaines-marketing-pricing` | Audit and optimize pricing | Plan tier structure, annual defaults, value metrics |
| `coreyhaines-marketing-paywalls` | Paywall optimization | Trial → paid, free → paid conversion |
| `coreyhaines-marketing-sales-enablement` | Build sales decks, one-pagers, demos | B2B sales support material |
| `coreyhaines-marketing-revops` | Revenue operations, lead lifecycle | Marketing → sales handoff |
| `coreyhaines-marketing-ab-testing` | Pricing experiments | Test annual default, intro pricing, tier consolidation |

### Cross-cutting / brand foundation skills

| Skill | What it does | Primary use |
|---|---|---|
| `coreyhaines-marketing-product-marketing` | Set up the AI-OS brand context in `brand_context/` (`positioning.md`, `icp.md`, `voice-profile.md`) | Foundational - run first; every section of the plan references this |
| `coreyhaines-marketing-customer-research` | Conduct customer interviews + surveys | Section 2 + Section 3 (Current state) |
| `coreyhaines-marketing-marketing-psychology` | Apply behavioral science | Cross-cuts copy, CRO, paywalls |
| `coreyhaines-marketing-marketing-ideas` | The 139-idea library | Section 12 of plan (Idea bank) |
...
| **Seed close** | + first marketing hire (lifecycle/content owner) | + paid ad accounts (Apple Search Ads, Meta, LinkedIn) + `coreyhaines-marketing-ads` skill activated | + paid acquisition pilot ($5-15K/mo - see `funding-stage-unlocks.md` for canonical tiers) |
...
- *"In two weeks, the team scaled from 0 to 14 ranking keywords using `coreyhaines-marketing-programmatic-seo` against the Ahrefs API + GitHub MCP - no dedicated SEO hire required."*
- *"The first email campaign generated a 24% reply rate after `coreyhaines-marketing-cold-email` skill + GA4 MCP + Stripe MCP gave the team a verified target list of users with high LTV but no recent activity."*
