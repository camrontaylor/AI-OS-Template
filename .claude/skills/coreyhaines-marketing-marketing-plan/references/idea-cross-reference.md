...
The `coreyhaines-marketing-marketing-ideas` skill catalogs 139 proven marketing tactics. This doc is the source-of-truth mapping: every idea assigned to a primary AARRR stage, with notes for when it's typically active and what category constraints apply.
...
- **"Entries" counts rows; idea IDs are unique.** Section header counts reflect rows in this doc, not unique ideas from `coreyhaines-marketing-marketing-ideas`.
- **Numbers correspond exactly to the `coreyhaines-marketing-marketing-ideas` skill ordering.** If `coreyhaines-marketing-marketing-ideas` reorders or expands, update this doc.
...
If `coreyhaines-marketing-marketing-ideas` adds new ideas (it's a living skill - the 139 may become 145 or 160 over time):
1. Read `.claude/skills/coreyhaines-marketing-marketing-ideas/references/ideas-by-category.md`
...
- `.claude/skills/coreyhaines-marketing-marketing-ideas/SKILL.md`
- `.claude/skills/coreyhaines-marketing-marketing-ideas/references/ideas-by-category.md`
