---
name: coreyhaines-marketing-marketing-plan
description: "Produce a comprehensive 12-month marketing plan structured by AARRR (Acquisition, Activation, Retention, Referral, Revenue), customized to the client's budget, team, and stage, cross-referenced with the 139-idea library and a 17-section current-state audit, output as a Notion-paste-ready doc. Not for a single channel (see the channel skill) or just ideas (coreyhaines-marketing-marketing-ideas)."
when_to_use: 'Invoke when the request sounds like: ''marketing plan'', ''growth plan'', ''GTM plan'', ''90-day plan'', ''12-month roadmap'', ''fCMO plan'''
---
...
| `context/learnings.md` | `## coreyhaines-marketing-marketing-plan` | Past corrections and preferences for this skill |
...
**Do not use** when the user wants a tactical execution document for a single channel (use the channel-specific skill instead - `coreyhaines-marketing-emails`, `coreyhaines-marketing-ads`, `coreyhaines-marketing-seo-audit`, `coreyhaines-marketing-onboarding`, etc.), or when the user just wants marketing ideas without commitment to a plan (use `coreyhaines-marketing-marketing-ideas`).
...
On invocation, the skill reads `projects/coreyhaines-marketing-marketing-plan/{client-slug}/progress.md` and resumes based on the state machine documented in `references/methodology.md` Step 1.1.2 (fresh → INIT → REVIEW → FINALIZE → finalized). Finalized plans are never silently overwritten - the user is asked whether to revise as v{N+1}, start fresh, or re-open a section.
...
Optionally offer to share it so the team can see it - paste into Notion via the connector (the working surface for shared docs), or push to a shared repo the user names. Confirm before any outward publish per the AI-OS external-action approval gates.
...
12. **Tactical idea bank** - All 139 ideas from `coreyhaines-marketing-marketing-ideas` cross-referenced to AARRR + client-specific status (Now / Q2 / Q3+ / Q4+ / Skip).
...
1. **`coreyhaines-marketing-marketing-ideas`** - 139 proven marketing tactics. Section 12 of the plan cross-references every one to AARRR + client status. Detail in `references/idea-cross-reference.md`.
2. **`coreyhaines-marketing-product-marketing`** - Sets up the foundational brand context in `brand_context/` - `positioning.md`, `icp.md`, `voice-profile.md`. Read these first; Section 2 (Strategic frame) builds on them.
3. **AARRR-stage-specific skills** - `coreyhaines-marketing-onboarding`, `coreyhaines-marketing-signup`, `coreyhaines-marketing-emails`, `coreyhaines-marketing-referrals`, `coreyhaines-marketing-pricing`, etc. The "Marketing operations stack" (Section 11) maps these to AARRR stages.
...
The final deliverable is a single markdown file: `projects/coreyhaines-marketing-marketing-plan/{client-slug}/final_plan.md`.
...
```
projects/coreyhaines-marketing-marketing-plan/
└── {client-slug}/
...
- **`coreyhaines-marketing-product-marketing`** - Run first. Captures positioning, ICP, voice in `brand_context/` so every section of the plan references the same foundation.
- **`coreyhaines-marketing-marketing-ideas`** - Source of the 139 tactics in Section 12.
- **`coreyhaines-marketing-customer-research`** - Deepens the ICP and voice-of-customer inputs that feed Section 2 (Strategic frame).
- **`coreyhaines-marketing-onboarding`** - Deep work on Section 5 (Activation).
- **`coreyhaines-marketing-emails`** - Deep work on Section 6 (Retention) + onboarding emails in Section 5.
- **`coreyhaines-marketing-referrals`** - Deep work on Section 7 (Referral).
- **`coreyhaines-marketing-pricing`** - Deep work on Section 8 (Revenue).
- **`coreyhaines-marketing-seo-audit`** / **`coreyhaines-marketing-ai-seo`** / **`coreyhaines-marketing-programmatic-seo`** - Deep work on the SEO portion of Section 4 (Acquisition).
- **`coreyhaines-marketing-ads`** / **`coreyhaines-marketing-ad-creative`** - Deep work on the paid portion of Section 4 once budget unlocks.
- **`coreyhaines-marketing-launch`** - Deep work on launch moments inside Section 4 / Section 9.
