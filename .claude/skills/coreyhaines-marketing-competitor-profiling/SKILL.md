---
name: coreyhaines-marketing-competitor-profiling
description: "Research and profile competitors from a list of their URLs, producing structured competitor dossier markdown files that combine live site scraping with SEO and market data. Not for building comparison or alternative pages from profiles (see coreyhaines-marketing-competitors), or sales battle cards (see coreyhaines-marketing-sales-enablement)."
when_to_use: 'Invoke when the request sounds like: "profile these competitors", "competitor research", "competitive intelligence", "competitor deep dive", "who are my competitors", "competitor dossier"'
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-competitor-profiling` | Past corrections and preferences for this skill |

## Initial Assessment

**Check for product marketing context first:**
Read the AI-OS brand context in `brand_context/` - `positioning.md`, `icp.md`, and `voice-profile.md` (and `samples.md` or `assets.md` when useful) - before asking questions. Use it and only ask for information not already covered. If those files do not exist yet, ask the user or offer to build them with `coreyhaines-marketing-product-marketing` or the AI-OS foundation skills `mkt-positioning`, `mkt-icp`, and `mkt-brand-voice`.
...
**Directory layout** (relative to the AI-OS workspace root):

```
projects/coreyhaines-marketing-competitor-profiling/
├── raw/
│   └── <competitor-slug>/
│       └── <YYYY-MM-DD>/
...
Save each result to `projects/coreyhaines-marketing-competitor-profiling/raw/<competitor-slug>/<YYYY-MM-DD>/scrapes/<page-name>.md` before extracting fields.
...
Save each scraped review page to `projects/coreyhaines-marketing-competitor-profiling/raw/<competitor-slug>/<YYYY-MM-DD>/reviews/<source>.md`. Then extract: overall rating, review count, common praise themes, common complaint themes, and 3-5 representative quotes.

---

### Phase 2: SEO & Market Data (DataForSEO)

Use DataForSEO MCP tools to gather quantitative competitive intelligence. Save each raw response as JSON to `projects/coreyhaines-marketing-competitor-profiling/raw/<competitor-slug>/<YYYY-MM-DD>/seo/<endpoint-name>.json` before parsing it into the profile. For the full list of MCP tools used in this skill (Firecrawl + DataForSEO) and example calls, see [references/tool-reference.md](references/tool-reference.md).
...
Generate one markdown file per competitor, saved to a `projects/coreyhaines-marketing-competitor-profiling/` directory in the AI-OS workspace.

**Filename**: `projects/coreyhaines-marketing-competitor-profiling/[competitor-name].md`
...
After profiling all competitors, generate a `projects/coreyhaines-marketing-competitor-profiling/_summary.md` that includes:
...
- **coreyhaines-marketing-competitors**: For creating comparison/alternative pages from these profiles
- **coreyhaines-marketing-prospecting**: For broader list-building qualification (this skill does deep research on specific accounts; prospecting builds the initial list)
- **coreyhaines-marketing-customer-research**: For mining reviews and community sentiment in depth
- **coreyhaines-marketing-content-strategy**: For using competitor content gaps to plan your own content
- **coreyhaines-marketing-seo-audit**: For auditing your own site relative to competitors
- **coreyhaines-marketing-sales-enablement**: For turning profiles into battle cards and sales collateral
- **coreyhaines-marketing-ads**: For analyzing competitor ad strategies
- **coreyhaines-marketing-pricing**: For deeper pricing analysis informed by competitor profiles
