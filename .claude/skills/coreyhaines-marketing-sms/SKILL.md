---
name: coreyhaines-marketing-sms
description: "Plan, build, and optimize SMS and MMS marketing programs - welcome, abandoned cart, post-purchase, win-back, and promo flows - with TCPA and A2P 10DLC compliance, copy, platform picks, and metrics. Not for email sequences (see coreyhaines-marketing-emails) or phone-capture popups (see coreyhaines-marketing-popups)."
when_to_use: 'Invoke when the request sounds like: "SMS marketing", "text message campaigns", "abandoned cart text", "Klaviyo/Postscript/Attentive SMS", "A2P 10DLC", "SMS vs email"'
metadata:
  version: 1.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-sms` | Past corrections and preferences for this skill |
...
For implementation, see the [tools registry](docs/connectors.md). Key SMS tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **Klaviyo** | E-commerce email + SMS combined | ✓ | [klaviyo.md](docs/connectors.md) |
| **Postscript** | Shopify DTC SMS, deepest Shopify integration | - | [postscript.md](docs/connectors.md) |
| **Attentive** | Mid-market+ DTC SMS, full-service | - | [attentive.md](docs/connectors.md) |
| **Twilio** | Raw API for custom builds, transactional, dev-first | - | [twilio.md](docs/connectors.md) |
| **Plivo** | Twilio alternative, lower per-send cost | - | [plivo.md](docs/connectors.md) |
| **AudienceTap** | AI-forward DTC, on-pack QR opt-in | - | [audiencetap.md](docs/connectors.md) |
| **Brevo** | EU email + SMS, SMB-friendly | ✓ | [brevo.md](docs/connectors.md) |
| **Customer.io** | Behavior-based SMS automation | - | [customer-io.md](docs/connectors.md) |
