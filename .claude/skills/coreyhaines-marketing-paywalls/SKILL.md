---
name: coreyhaines-marketing-paywalls
description: "Design and optimize in-product upgrade moments - paywalls, upgrade screens, upsell modals, feature gates - to convert free users to paid after they have hit value. Not for public pricing pages (see coreyhaines-marketing-cro) or pricing decisions (see coreyhaines-marketing-pricing)."
when_to_use: 'Invoke when the request sounds like: "paywall", "upgrade screen", "upsell modal", "feature gate", "trial to paid conversion", "free users won''t upgrade"'
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-paywalls` | Past corrections and preferences for this skill |
...
- **coreyhaines-marketing-churn-prevention**: For cancel flows, save offers, and reducing churn post-upgrade
- **coreyhaines-marketing-cro**: For public pricing page optimization
- **coreyhaines-marketing-onboarding**: For driving to aha moment before upgrade
- **coreyhaines-marketing-ab-testing**: For testing paywall variations
