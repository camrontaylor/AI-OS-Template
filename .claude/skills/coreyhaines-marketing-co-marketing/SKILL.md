---
name: coreyhaines-marketing-co-marketing
description: "Find co-marketing partners and plan joint campaigns for SaaS - audience-overlap analysis, partner-fit scoring, joint launch and cross-promotion ideas, and agreement structure. Not for customer referral programs (see coreyhaines-marketing-referrals) or launch-specific partnerships (see coreyhaines-marketing-launch)."
when_to_use: 'Invoke when the request sounds like: ''co-marketing'', ''partner marketing'', ''who should we partner with'', ''joint campaign'', ''cross-promotion'', ''integration marketing'''
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-co-marketing` | Past corrections and preferences for this skill |
...
For implementation, see the [AI-OS connectors map](../../../docs/connectors.md). Key tools for co-marketing:

| Tool | Best For | Guide |
|------|----------|-------|
| **Crossbeam** | Account overlap with partners | [connectors map](../../../docs/connectors.md) |
| **Introw** | Partner program management, deal registration | [connectors map](../../../docs/connectors.md) |
| **PartnerStack** | Partner and affiliate program management | [connectors map](../../../docs/connectors.md) |

---

## Related Skills

- **coreyhaines-marketing-referrals** - For customer referral and affiliate programs (customers referring customers)
- **coreyhaines-marketing-launch** - For product launches with partners; covers co-marketing as a "borrowed channel"
- **coreyhaines-marketing-content-strategy** - For content planning including co-created content
- **coreyhaines-marketing-sales-enablement** - For partner-facing collateral and enablement materials
