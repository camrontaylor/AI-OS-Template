---
name: coreyhaines-marketing-marketing-psychology
description: "Apply psychological principles and mental models to marketing: cognitive biases, persuasion, behavioral science, and decision-making frameworks explained with concrete marketing applications. Not for applying it to specific pages (coreyhaines-marketing-cro), pricing tactics (coreyhaines-marketing-pricing), or copy framing (coreyhaines-marketing-copywriting)."
when_to_use: 'Invoke when the request sounds like: ''mental models'', ''cognitive bias'', ''why people buy'', ''social proof'', ''loss aversion'', ''anchoring'''
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-marketing-psychology` | Past corrections and preferences for this skill |

## How to Use This Skill

**Check for brand context first:**
Read AI-OS brand context in `brand_context/` - `positioning.md`, `icp.md`, and `voice-profile.md` (plus `samples.md` / `assets.md` when useful) - before applying mental models. Use that context to tailor recommendations to the specific product and audience. If those files do not exist yet, ask the user for what you need or offer to build them with `coreyhaines-marketing-product-marketing` or the AI-OS foundation skills `mkt-positioning`, `mkt-icp`, and `mkt-brand-voice`.
...
- **coreyhaines-marketing-cro**: Apply psychology to page optimization
- **coreyhaines-marketing-copywriting**: Write copy using psychological principles
- **coreyhaines-marketing-popups**: Use triggers and psychology in popups
- **pricing-page optimization**: See coreyhaines-marketing-cro for pricing psychology
- **coreyhaines-marketing-ab-testing**: Test psychological hypotheses
