---
name: coreyhaines-marketing-copy-editing
description: "Edit, review, and polish existing marketing copy through focused passes, or refresh outdated content, without rewriting from scratch. Not for writing new copy from scratch (see coreyhaines-marketing-copywriting)."
when_to_use: 'Invoke when the request sounds like: "edit this copy", "review my copy", "proofread", "tighten this up", "too wordy", "refresh this content"'
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-copy-editing` | Past corrections and preferences for this skill |

## Core Philosophy

**Check for brand context first:**
Read the AI-OS brand context in `brand_context/` before editing: `positioning.md`, `icp.md`, and `voice-profile.md` (plus `samples.md` / `assets.md` when useful). Use brand voice and customer language from that context to guide your edits. If those files do not exist yet, ask the user, or offer to build them with `coreyhaines-marketing-product-marketing` or the AI-OS foundation skills `mkt-positioning`, `mkt-icp`, and `mkt-brand-voice`.
...
- **coreyhaines-marketing-copywriting**: For writing new copy from scratch (use this skill to edit after your first draft is complete)
- **coreyhaines-marketing-cro**: For broader page optimization beyond copy
- **coreyhaines-marketing-marketing-psychology**: For understanding why certain edits improve conversion
- **coreyhaines-marketing-ab-testing**: For testing copy variations
...
| Task | Skill to Use |
|------|--------------|
| Writing new page copy from scratch | coreyhaines-marketing-copywriting |
| Reviewing and improving existing copy | coreyhaines-marketing-copy-editing (this skill) |
| Editing copy you just wrote | coreyhaines-marketing-copy-editing (this skill) |
| Structural or strategic page changes | coreyhaines-marketing-cro |
