---
name: coreyhaines-marketing-site-architecture
description: "Plan a website page hierarchy, navigation, URL structure, and internal linking - delivers ASCII trees, Mermaid sitemaps, URL maps, and nav specs. Not for XML sitemap.xml or SEO audits (see coreyhaines-marketing-seo-audit), or structured data (see coreyhaines-marketing-schema)."
when_to_use: 'Invoke when the request sounds like: "sitemap", "site structure", "information architecture", "what pages do I need", "navigation design", "internal linking strategy"'
metadata:
  version: 2.0.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-site-architecture` | Past corrections and preferences for this skill |
