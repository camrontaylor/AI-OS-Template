---
name: coreyhaines-marketing-video
description: "Produce marketing videos with AI tools and code - AI generation (Veo, Sora, Runway, Kling), AI avatars (HeyGen, Synthesia), programmatic frameworks (Remotion, Hyperframes), editing/repurposing, and reverse-engineering a viral edit. Not for video strategy (see coreyhaines-marketing-social) or paid video ads (see coreyhaines-marketing-ad-creative)."
when_to_use: 'Invoke when the request sounds like: "AI video", "make me a video", "product demo video", "talking head video", "Remotion", "copy this edit"'
metadata:
  version: 2.1.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-video` | Past corrections and preferences for this skill |
...
1. **Script** the key features and value props (use `coreyhaines-marketing-copywriting` skill)
...
| Tool | Type | MCP | Guide |
|------|------|:---:|-------|
| **HeyGen** | AI avatars | Yes | [heygen.md](docs/connectors.md) |
| **Hyperframes** | Programmatic video | - | [hyperframes.md](docs/connectors.md) |
