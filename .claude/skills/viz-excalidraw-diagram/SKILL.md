...
description: "Generate Excalidraw diagram JSON that makes a visual argument, not just labelled boxes: workflows, architectures, concepts, system designs. Not for inline SVG diagrams, charts, or slide decks."
when_to_use: 'Invoke when the request sounds like: "excalidraw diagram", "draw a diagram", "visualize this workflow", "architecture diagram", "system diagram", "diagram this". Renders to PNG and validates in a loop'
---
...
- 2026-06-25: When a user flags clutter, arrow/text collisions, or poor visibility, increase the canvas and spacing rather than removing information; use swimlanes, gutters, shorter labels inside boxes, and route arrows around reading areas. If the user requests a restrained palette, use grayscale fills with one accent colour.
- 2026-06-25: For dense architecture diagrams, prefer a columnar layout with connector gutters between columns. Do not route arrows or dashed write-back paths across explanatory panels, result strips, or long body-copy blocks.
