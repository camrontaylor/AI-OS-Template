---
name: coreyhaines-marketing-ad-creative
description: "Generate and iterate ad creative at scale - headlines, descriptions, primary text, plus static and motion ad concepts for Google, Meta, LinkedIn, TikTok, and X, including performance-data-driven iterations. Not for campaign strategy and targeting (see coreyhaines-marketing-ads) or landing page copy (see coreyhaines-marketing-copywriting)."
when_to_use: 'Invoke when the request sounds like: ''write me some ads'', ''ad copy variations'', ''RSA headlines'', ''bulk ad copy'', ''creative testing'', ''I need more ad variations'''
metadata:
  version: 2.8.0
---
...
| `context/learnings.md` | `## coreyhaines-marketing-ad-creative` | Past corrections and preferences for this skill |
...
projects/coreyhaines-marketing-ad-creative/   Dated batch folders (projects/coreyhaines-marketing-ad-creative/YYYY-MM-DD/)
```
...
```
projects/coreyhaines-marketing-ad-creative/YYYY-MM-DD/
...
For pulling performance data and managing campaigns, see the [AI-OS connectors map](../../../docs/connectors.md).

| Platform | Pull Performance Data | Manage Campaigns | Guide |
|----------|:---------------------:|:----------------:|-------|
| **Google Ads** | `google-ads campaigns list`, `google-ads reports get` | `google-ads campaigns create` | [connectors map](../../../docs/connectors.md) |
| **Meta Ads** | `meta-ads insights get` | `meta-ads campaigns list` | [connectors map](../../../docs/connectors.md) |
| **LinkedIn Ads** | `linkedin-ads analytics get` | `linkedin-ads campaigns list` | [connectors map](../../../docs/connectors.md) |
| **TikTok Ads** | `tiktok-ads reports get` | `tiktok-ads campaigns list` | [connectors map](../../../docs/connectors.md) |
...
- **coreyhaines-marketing-ads**: For campaign strategy, targeting, budgets, and optimization
- **coreyhaines-marketing-marketing-loops**: For running static batch generation on a recurring cadence (the daily-creative-drop loop)
- **coreyhaines-marketing-customer-research**: For mining reviews and comments when building the grounded inputs corpus
- **coreyhaines-marketing-copywriting**: For landing page copy (where ad traffic lands)
- **coreyhaines-marketing-ab-testing**: For structuring creative tests with statistical rigor
- **coreyhaines-marketing-marketing-psychology**: For psychological principles behind high-performing creative
- **coreyhaines-marketing-copy-editing**: For polishing ad copy before launch
