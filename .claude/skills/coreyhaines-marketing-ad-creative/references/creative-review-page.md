...
1. Copy `assets/creative-review-template.html` into the batch's output folder as `review.html` (e.g. `projects/coreyhaines-marketing-ad-creative/YYYY-MM-DD/review.html`).
