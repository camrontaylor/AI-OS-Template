...
Save the script at `projects/coreyhaines-skills-slide-deck/conversions/_scripts/extract_pptx.py`:
...
```bash
python3 projects/coreyhaines-skills-slide-deck/conversions/_scripts/extract_pptx.py \
  "<path-to-pptx>" \
  projects/coreyhaines-skills-slide-deck/conversions/<slug>-from-pptx/
```
...
For images:
1. Copy from `projects/coreyhaines-skills-slide-deck/conversions/<slug>-from-pptx/assets/` to `${SLIDE_DECK_REPO:-$HOME/code/your-slide-deck-site}/public/slide-assets/<slug>/`
