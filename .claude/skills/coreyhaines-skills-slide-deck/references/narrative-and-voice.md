...
Same pattern as `coreyhaines-skills-jab-hook`'s voice reference: layer personal rules on top via `projects/coreyhaines-skills-slide-deck/voice.local.md`. The skill loads generic rules first, then your overlay.
