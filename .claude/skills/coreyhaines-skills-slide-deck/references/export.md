...
Save as `projects/coreyhaines-skills-slide-deck/exports/_scripts/snapshot.mjs` (create on first run):
...
```bash
mkdir -p projects/coreyhaines-skills-slide-deck/exports/<slug>-$(date +%Y-%m-%d)
node projects/coreyhaines-skills-slide-deck/exports/_scripts/snapshot.mjs <slug> <count> projects/coreyhaines-skills-slide-deck/exports/<slug>-$(date +%Y-%m-%d)
```
...
```bash
img2pdf projects/coreyhaines-skills-slide-deck/exports/<slug>-<date>/slide-*.png \
  -o projects/coreyhaines-skills-slide-deck/exports/<slug>-<date>/<slug>.pdf
```

Alternative: ImageMagick (more flexible, larger output):

```bash
magick projects/coreyhaines-skills-slide-deck/exports/<slug>-<date>/slide-*.png \
  projects/coreyhaines-skills-slide-deck/exports/<slug>-<date>/<slug>.pdf
```

Open after generation:

```bash
open projects/coreyhaines-skills-slide-deck/exports/<slug>-<date>/<slug>.pdf
```
...
2. Deploy:
   ```bash
   cd projects/coreyhaines-skills-slide-deck/exports/<slug>-<date>/ && vercel --prod --yes
   ```
