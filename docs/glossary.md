...
| `/start-here` | The first-run onboarding command for new users. It is an alias for `/onboarding`. |
| `/onboarding` | The underlying command that runs first-run setup, brand context, skill selection, and orientation. |
